...
if (typeof fanva === 'undefined') {
	var fanva = require('./fanva.js');
}

var cribe = ".ni'oni'o lu loi guzmrkukurbita cu fadni le ka go'o lo'i mivmu'e li'u se cusku la pafcribe goi pycy. ca le nu pycy joi le re ribve'a mo'u cicyspavi'u fi le guzme purdi .i lu roda naku su'ode rodi zo'u da de simsa di .ije da na'e du de li'u go'i\n" +
	"\n" +
	...
	"\n" +
	".i ko'e bavla'i fi lo nu cmodji .i la kirdei pu se finti fi lo nu ckire .enai le nu jinga le la ben po'u lo cagypre ge'u palku\n" +
	"\n" +
